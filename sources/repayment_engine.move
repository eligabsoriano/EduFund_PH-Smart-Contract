...
module edufund::repayment_engine {
    ...
    entry fun create_schedule(
        ...
        transfer::transfer(schedule, ctx.sender());
    }

    entry fun make_payment<T>(
    ...
    entry fun close_loan(schedule: RepaymentSchedule) {
